...
const defaultCosts = { precio_venta: 0, costo_laboratorio: 0, costo_montura: 0, costo_lente: 0, costo_insumos: 0, comision_financiera: 0, utilidad_calculada: 0 };

export const mockProductos: OrdenProducto[] = [
  { id: 'p1', orden_id: 'o1', paciente_nombre: 'María García', tipo_producto: 'lente', descripcion: 'Progresivo Varilux X', laboratorio_nombre: 'Servioptica', estado_actual: 'pedido_creado', fecha_creacion: '2026-03-09', dias_en_estado: 2, tiempo_esperado_dias: 3, es_garantia: false, es_reproceso: false, ...defaultCosts },
  { id: 'p2', orden_id: 'o1', paciente_nombre: 'María García', tipo_producto: 'montura', descripcion: 'Ray-Ban RB5228', laboratorio_nombre: 'N/A', estado_actual: 'listo_entrega', fecha_creacion: '2026-03-05', dias_en_estado: 1, tiempo_esperado_dias: 1, es_garantia: false, es_reproceso: false, ...defaultCosts },
  { id: 'p3', orden_id: 'o2', paciente_nombre: 'Carlos Rodríguez', tipo_producto: 'lente', descripcion: 'Bifocal FT-28 CR39', laboratorio_nombre: 'Industrias Ópticas', estado_actual: 'en_produccion', fecha_creacion: '2026-03-07', dias_en_estado: 3, tiempo_esperado_dias: 3, es_garantia: false, es_reproceso: false, ...defaultCosts },
  { id: 'p4', orden_id: 'o3', paciente_nombre: 'Ana Martínez', tipo_producto: 'lente', descripcion: 'Monofocal AR Blue', laboratorio_nombre: 'Servioptica', estado_actual: 'enviado_laboratorio', fecha_creacion: '2026-03-10', dias_en_estado: 1, tiempo_esperado_dias: 1, es_garantia: false, es_reproceso: false, ...defaultCosts },
  { id: 'p5', orden_id: 'o4', paciente_nombre: 'Luis Hernández', tipo_producto: 'lente', descripcion: 'Progresivo Hoyalux iD', laboratorio_nombre: 'Hoya', estado_actual: 'control_calidad', fecha_creacion: '2026-03-03', dias_en_estado: 1, tiempo_esperado_dias: 3, es_garantia: false, es_reproceso: false, ...defaultCosts },
  { id: 'p6', orden_id: 'o5', paciente_nombre: 'Patricia Moreno', tipo_producto: 'lente', descripcion: 'Monofocal Transitions', laboratorio_nombre: 'Essilor', estado_actual: 'recibido_optica', fecha_creacion: '2026-03-04', dias_en_estado: 2, tiempo_esperado_dias: 1, es_garantia: true, es_reproceso: false, ...defaultCosts },
  { id: 'p7', orden_id: 'o6', paciente_nombre: 'Andrés Castro', tipo_producto: 'lente', descripcion: 'Ocupacional Digital', laboratorio_nombre: 'Servioptica', estado_actual: 'producido', fecha_creacion: '2026-03-06', dias_en_estado: 1, tiempo_esperado_dias: 3, es_garantia: false, es_reproceso: false, ...defaultCosts },
  { id: 'p8', orden_id: 'o6', paciente_nombre: 'Andrés Castro', tipo_producto: 'montura', descripcion: 'Oakley OX8046', laboratorio_nombre: 'N/A', estado_actual: 'entregado', fecha_creacion: '2026-03-01', dias_en_estado: 0, tiempo_esperado_dias: 1, es_garantia: false, es_reproceso: false, ...defaultCosts },
  { id: 'p9', orden_id: 'o7', paciente_nombre: 'Rosa Jiménez', tipo_producto: 'lente', descripcion: 'Monofocal CR39', laboratorio_nombre: 'Industrias Ópticas', estado_actual: 'en_transito', fecha_creacion: '2026-03-05', dias_en_estado: 1, tiempo_esperado_dias: 1, es_garantia: false, es_reproceso: true, ...defaultCosts },
  { id: 'p10', orden_id: 'o8', paciente_nombre: 'Fernando Pérez', tipo_producto: 'lente', descripcion: 'Progresivo Zeiss', laboratorio_nombre: 'Zeiss', estado_actual: 'recibido_laboratorio', fecha_creacion: '2026-03-08', dias_en_estado: 2, tiempo_esperado_dias: 3, es_garantia: false, es_reproceso: false, ...defaultCosts },
];
